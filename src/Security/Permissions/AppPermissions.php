...
final class AppPermissions
{
    ...
    public const TIMESHEET_VIEW = 'ROLE_TIMESHEET_VIEW';
    public const TIMESHEET_VIEW_DEPARTMENT = 'ROLE_TIMESHEET_VIEW_DEPARTMENT';
    public const TIMESHEET_VIEW_ANY = 'ROLE_TIMESHEET_VIEW_ANY';
    public const TIMESHEET_MANAGE_OWN = 'ROLE_TIMESHEET_MANAGE_OWN';
    public const TIMESHEET_MANAGE_DEPARTMENT = 'ROLE_TIMESHEET_MANAGE_DEPARTMENT';
    public const TIMESHEET_MANAGE_ANY = 'ROLE_TIMESHEET_MANAGE_ANY';
    public const TIMESHEET_ADMIN = 'ROLE_TIMESHEET_ADMIN';
}
