        ...
        if ($this->security->isGranted(AppPermissions::USER_ADMIN)) {
            $builder->add('permissions', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    'Табель' => [
                        'Табель: просмотр своего табеля' => AppPermissions::TIMESHEET_VIEW,
                        'Табель: просмотр табелей своего отдела' => AppPermissions::TIMESHEET_VIEW_DEPARTMENT,
                        'Табель: просмотр табелей всех отделов' => AppPermissions::TIMESHEET_VIEW_ANY,
                        'Табель: редактирование своего табеля' => AppPermissions::TIMESHEET_MANAGE_OWN,
                        'Табель: редактирование табелей своего отдела' => AppPermissions::TIMESHEET_MANAGE_DEPARTMENT,
                        'Табель: редактирование табелей всех отделов' => AppPermissions::TIMESHEET_MANAGE_ANY,
                        'Табель: администрирование' => AppPermissions::TIMESHEET_ADMIN,
                    ],
                ],
                'multiple' => true,
                'expanded' => true,
